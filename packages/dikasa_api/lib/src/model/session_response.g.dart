...
abstract class _$SessionResponseCWProxy {
  SessionResponse data(SessionData data);
  ...
  /// ````
  SessionResponse call({SessionData data});
}
...
class _$SessionResponseCWProxyImpl implements _$SessionResponseCWProxy {
  ...
  @override
  SessionResponse data(SessionData data) => this(data: data);
  ...
  /// SessionResponse(...).copyWith(id: 12, name: "My name")
  /// ````
  SessionResponse call({Object? data = const $CopyWithPlaceholder()}) {
