...
abstract class _$LoginRequestCWProxy {
  LoginRequest identifier(String identifier);
  ...
  /// ````
  LoginRequest call({String identifier, String password});
}
...
class _$LoginRequestCWProxyImpl implements _$LoginRequestCWProxy {
  ...
  @override
  LoginRequest identifier(String identifier) => this(identifier: identifier);
